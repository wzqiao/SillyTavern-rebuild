...
export const controlRadiusClass = 'rounded-[1.25rem]';

export const cardRadiusClass = 'rounded-[1.5rem]';

export const panelRadiusClass = 'rounded-[1.75rem]';

export const panelSurfaceClass =
    'rounded-[1.75rem] border border-white/10 bg-neutral-900/82 shadow-[0_24px_100px_rgba(0,0,0,0.38)] backdrop-blur-xl';

export const insetSurfaceClass =
    'rounded-[1.5rem] border border-white/8 bg-neutral-950/72 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]';
