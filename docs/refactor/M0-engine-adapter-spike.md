...
- Decide how the typed memory-only connection handoff should be safely injected into the SillyTavern runtime adapter or backend settings layer; the current handoff is intentionally not a live connection and does not persist secrets.
